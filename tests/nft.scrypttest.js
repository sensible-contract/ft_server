...
const { NFT } = require("../src/lib/sensible_nft/NFT");
const {
  PayloadNFT,
  ISSUE,
  TRANSFER,
  SWAP,
  SELL,
} = require("../src/lib/sensible_nft/PayloadNFT");
...
describe("Test sCrypt contract NFT In Javascript", async () => {
  ...
  const issuerPrivKey = new bsv.PrivateKey.fromWIF(
    "cPbFsSjFjCbfzTRc8M4nKNGhVJspwnPQAcDhdJgVr3Pdwpqq7LfA"
  );
  ...
  const receiver1PrivKey = new bsv.PrivateKey.fromWIF(
    "cRCsQuoGatjXDdzjYhb1r3RH8LDqCEvjNc8gYS7HcnodPf44guQG"
  );
  ...
  const receiver2PrivKey = new bsv.PrivateKey.fromWIF(
    "cNLWqaouzifBDZL44C7beiSUWt8k4R6Gj2fnG2tgqdAVSHpYv8He"
  );
  ...
  //////////////////////////////////////////////////////////////// 创建Swap Tx
  let codeWithGenesisPartHashSwap = bsv.crypto.Hash.sha256sha256(
    bsv.util.buffer.hexToBuffer("00")
  );
  ...
  //////////////////////////////////////////////////////////////// 创建Burn Tx
  let txTransferBurnPl = new PayloadNFT({
    dataType: TRANSFER,
    ownerPkh: receiver1Pkh,
    tokenId: currTokenId + 1,
  });
